...
QTweetRetweetToUser::QTweetRetweetToUser(QObject *parent) :
...
QTweetRetweetToUser::QTweetRetweetToUser(OAuthTwitter *oauthTwitter, QObject *parent) :
...
void QTweetRetweetToUser::fetch(qint64 userid,
                                qint64 sinceid,
                                qint64 maxid,
                                int count,
                                int page,
...
void QTweetRetweetToUser::fetch(const QString &screenName,
                                qint64 sinceid,
                                qint64 maxid,
                                int count,
                                int page,
...
void QTweetRetweetToUser::parseJsonFinished(const QJsonDocument &jsonDoc)
{
    if (jsonDoc.isArray()) {
